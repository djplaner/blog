...
!!! note "Dimensions of shadow system permissions"
    ...
    - Support - what support is provided by the organisation for shadow systems, possibilities might include: none, support of "innovation" trials, through to active design of organisational digital technology ecosystems that enable [end-user-programming](https://djon.es/memex/sense/Bricolage/end-user-programming.html)
...
!!! question "Can this be done (effectively) in a teleological design approach? How contextual?"
    ...
    There are two broad approaches to technological design: [ateleogical-versus-teleological](https://djon.es/memex/sense/CASA/ateleogical-versus-teleological.html). All organisational approaches use teleological design. An approach that starts with the goal, gathers requirements, and selects between choices before implementation. Such an approach tends to strip away messy complications about context in such decisions. The specifics of pedagogical approach to which a technology is applied or the specific needs of a single third year course in electrical engineering are some of the context that is ignored/lost within such an approach.
...
[end-user-programming](https://djon.es/memex/sense/Bricolage/end-user-programming.html)

[ateleogical-versus-teleological](https://djon.es/memex/sense/CASA/ateleogical-versus-teleological.html)
