...
The articles proposal that "REAs = RIAs + governance" seems to be harking back to the bad old days of command and control. We can only achieve these aims if we control how they do it.
