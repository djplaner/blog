...
Looking for evidence of these limitations is one of the reasons behind [this work](/blog/2016/08/07/how-and-why-do-people-use-the-moodle-book-module/) that is seeking to explore how and why people are using the Moodle Book module. My suspicion is that learners and teachers are seeing the Book module as a way to produce a print-based book. That they aren't seeing it as a way to create a collection of web pages, nor are they seeking to leverage the affordances that medium offers. Arguably, the same problem applies at the institutional level.

## A less boring way

It is in leveraging the affordances of web pages  that a less boring approach to open educational practices may lay. Early on in my use of the Book module I was [trying to move beyond](/blog/2012/07/15/redesigning-the-weekly-ramble/) seeing it as a book. Even though my suspicion is that most students continued to print them out (something I'm hoping to test real soon now), and I suspect that most within the institution still see the Moodle Book as a way to produce books to be printed. For example, [back in July 2012](/blog/2012/07/15/redesigning-the-weekly-ramble/) I identified this as the 3rd problem from student feedback.
...
Even though a [solution to this problem](https://github.com/stronk7/moodle-block_search_books) had been developed in 2009, the institution didn't have it installed. It wasn't until July 2016 [that it was installed](/blog/2016/05/10/testing-out-the-moodle-book-search/).
